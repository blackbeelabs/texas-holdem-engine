...
if __name__ == "__main__":
    ...
    player2 = Player(player_id=5, player_name="Jane", starting_stack=100)
    player3 = Player(player_id=4, player_name="Jim", starting_stack=100)
    player4 = Player(player_id=3, player_name="Jill", starting_stack=100)
    player5 = Player(player_id=2, player_name="Jack", starting_stack=100)
